...
```javascript
const logger = require('<path to src>/core/configs/logger');
...
const { toJSON, paginate } = require('<path to src>/core/plugins');
...
- [hagopj13/node-express-boilerplate](https://github.dev/hagopj13/node-express-boilerplate)
